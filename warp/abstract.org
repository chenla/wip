...
representing a different rate of change and abstraction.
   ...
   the sources I cite indicate, I came to via Joyce when in high
   school.  I mention this because coming to Vico via Joyce gets one
   tangled up with Bruno.  This is far from being a bad thing. But to
   untangle Bruno from Vico we must turn to Samuel Beckett who was
